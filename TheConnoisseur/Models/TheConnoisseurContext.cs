...
{
    public class TheConnoisseurContext : DbContext
    {
        ...
        public TheConnoisseurContext() : base("name=TheConnoisseurContext")
        {
        }

        public System.Data.Entity.DbSet<TheConnoisseur.Models.Journal> Journals { get; set; }

        public System.Data.Entity.DbSet<TheConnoisseur.Models.Author> Authors { get; set; }
